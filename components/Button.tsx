...
export default function Button({
  ...
  const baseStyles = "relative font-medium rounded-xl transition-all duration-300 ease-out focus:outline-none focus:ring-2 focus:ring-white/20 focus:ring-offset-2 focus:ring-offset-[#0A0A0C] overflow-hidden group";
  ...
  const variants = {
    ...
    ghost: "bg-transparent text-white/70 border border-transparent hover:bg-[#0C0C10]/50 hover:border-white/10 hover:text-white hover:shadow-[0_4px_16px_rgba(0,0,0,0.3)] hover:scale-[1.01] active:scale-[0.98] transition-all duration-300",
